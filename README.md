...
El proyecto funciona correctamente en entorno local.

El backend fue configurado en Render; durante el despliegue se presentó un conflicto con dependencias nativas de SQLite/better-sqlite3 en ambiente Linux.
